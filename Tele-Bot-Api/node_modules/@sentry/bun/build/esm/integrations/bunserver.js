import { defineIntegration, withIsolationScope, SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN, SEMANTIC_ATTRIBUTE_SENTRY_SOURCE, continueTrace, startSpan, setHttpStatus, captureException } from '@sentry/core';
 ...
 * ```
 */
const bunServerIntegration = defineIntegration(_bunServerIntegration);
...
export { bunServerIntegration, instrumentBunServe };
